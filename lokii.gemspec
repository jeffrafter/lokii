...
Gem::Specification.new do |s|
  ...
  s.executables = ["lokii"]
  s.files = ["Rakefile.example", "README.textile", "VERSION.yml", "bin/lokii", "lib/lokii", "lib/lokii/config.rb", "lib/lokii/handler.rb", "lib/lokii/handlers", "lib/lokii/handlers/i_love_you_handler.rb", "lib/lokii/handlers/ping_handler.rb", "lib/lokii/logger.rb", "lib/lokii/models", "lib/lokii/models/inbox.rb", "lib/lokii/models/multipart_inbox.rb", "lib/lokii/models/outbox.rb", "lib/lokii/processor.rb", "lib/lokii/server.rb", "lib/lokii/servers", "lib/lokii/servers/database_server.rb", "lib/lokii/servers/gsm_proxy.rb", "lib/lokii/servers/gsm_server.rb", "lib/lokii/servers/memory_server.rb", "lib/lokii.rb", "script/console", "script/daemon", "script/lokii", "script/smsd", "test/handlers", "test/handlers/i_love_you_handler_test.rb", "test/test_helper.example.rb", "test/test_helper.rb", "config/boot.rb", "config/init.rb", "config/process.rb", "config/settings.example.yml", "config/database.example.yml", "config/messages.example.yml"]
