...
Gem::Specification.new do |s|
  ...
  s.executables = ["lokii"]
  s.files = ["README.textile", "VERSION.yml", "bin/lokii", "lib/lokii", "lib/lokii/config.rb", "lib/lokii/handler.rb", "lib/lokii/handlers", "lib/lokii/handlers/i_love_you_handler.rb", "lib/lokii/handlers/ping_handler.rb", "lib/lokii/logger.rb", "lib/lokii/mapper.rb", "lib/lokii/models", "lib/lokii/models/inbox.rb", "lib/lokii/models/multipart_inbox.rb", "lib/lokii/models/outbox.rb", "lib/lokii/models/worker.rb", "lib/lokii/server.rb", "lib/lokii/servers", "lib/lokii/servers/database_server.rb", "lib/lokii.rb", "lib/process.rb", "test/test_helper.rb", "test/unit", "test/unit/i_love_you_handler_test.rb", "script/console", "script/daemon", "script/lokii", "script/smsd", "config/init.rb", "config/settings.example.yml", "config/database.example.yml"]
